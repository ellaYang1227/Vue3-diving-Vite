...
<template>
  ...
  >
    <div class="container">
      <RouterLink class="navbar-brand" to="/index">
        <img :src="logo" :alt="VITE_COMPANY_NAME" class="mb-md-2 logo-img" />
      </RouterLink>
      <RouterLink class="btn btn-primary btn-custom-rectangle ms-auto me-3 me-md-0 ms-md-2 order-md-last" to="/addActivity" role="button"
        >我要揪團</RouterLink
      >
      <button class="navbar-toggler" type="button" aria-controls="offcanvasNavbar" @click="toggleOffcanvasNavbar">
        <span class="navbar-toggler-icon"></span>
      </button>
      <div class="offcanvas-navbar offcanvas offcanvas-start border-0" tabindex="-1" ref="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
          ...
          <ul class="navbar-nav ms-auto align-items-md-center">
            <li class="nav-item dropdown order-md-last" :class="{ 'd-md-none': !user }">
              ...
              <ul class="dropdown-menu dropdown-menu-md-end" aria-labelledby="dropUser" :class="{ 'd-none': !user }">
                ...
                <li>
                  <RouterLink class="dropdown-item" to="/member/editMyinfo" @click="toggleOffcanvasNavbar">編輯個人資料</RouterLink>
                </li>
                <li>
                  <RouterLink class="dropdown-item" to="/member/editMyinfo" @click="toggleOffcanvasNavbar">我的潛水證照</RouterLink>
                </li>
                <li><hr class="dropdown-divider" /></li>
                <li>
                  <RouterLink class="dropdown-item" to="/member/myActivities" @click="toggleOffcanvasNavbar">我的揪團</RouterLink>
                </li>
                <li>
                  <RouterLink class="dropdown-item" to="/member/myOrders" @click="toggleOffcanvasNavbar">我的報名</RouterLink>
                </li>
                <li>
                  <RouterLink class="dropdown-item" to="/member/myComments" @click="toggleOffcanvasNavbar">評論管理</RouterLink>
                </li>
                <li><hr class="dropdown-divider" /></li>
                <li>
            ...
            <li class="nav-item">
              <RouterLink class="nav-link" to="/activities" @click="toggleOffcanvasNavbar">找揪團</RouterLink>
            </li>
            ...
            <template v-if="!user">
              <li class="nav-item">
                <RouterLink class="nav-link" to="/login" @click="toggleOffcanvasNavbar">登入</RouterLink>
              </li>
              <li class="nav-item">
                <RouterLink class="nav-link" to="/signup" @click="toggleOffcanvasNavbar">註冊</RouterLink>
              </li>
            </template>
            <template v-else>
              <li class="nav-item" v-if="user.identityId === '0' && false">
                <RouterLink class="nav-link" to="/admin/index" @click="toggleOffcanvasNavbar">後台管理</RouterLink>
              </li>
