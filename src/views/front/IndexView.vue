...
<template>
  ...
  <div class="bg-img pb-5 py-lg-5">
    <div class="container text-center py-5" data-aos="zoom-out-down">
      ...
      <div class="d-grid col-7 col-md-4 col-lg-3 mx-auto mt-4">
        <RouterLink to="addActivity" class="btn btn-outline-lightPrimary btn-lg rounded-pill" role="button">我要揪團</RouterLink>
      </div>
    </div>
      ...
      <div class="container py-4">
        <div class="row gx-0 gy-4 justify-content-center">
          ...
          >
            <img
              :src="bannerIcon.img"
              :alt="bannerIcon.title"
              class="banner-icon-size border border-style-dashed border-lightPrimary rounded-circle me-md-2"
            />
            <div class="text-center flex-grow-1 flex-md-grow-0">
              <span class="d-block text-primary fw-light font-barlow display-4 lh-1">
                <CountUp :endVal="bannerIcon.total" :duration="5"></CountUp></span
              >{{ bannerIcon.title }}
            </div>
          </div>
        </div>
  ...
  <div class="container">
    <!-- 熱門 / 最新 活動 -->
    <div data-aos="fade-up" class="py-4 py-md-6">
      <nav class="nav fs-4">
        <a
    ...
    <!-- 特點 -->
    <div class="row gy-4 justify-content-center py-4 py-md-6">
      <div
  ...
  <!-- 地點 -->
  <div class="bg-primary bg-opacity-20 my-4 my-md-6 py-3" data-aos="fade-up">
  ...
  <div class="container">
    <!-- 評論 -->
    <div class="py-4 py-md-6" data-aos="zoom-out">
    ...
    <!-- 好評主揪開團 -->
    <div class="py-4 py-md-6" data-aos="fade-up">
