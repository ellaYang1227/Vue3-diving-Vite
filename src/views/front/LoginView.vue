  ...
  <div class="container py-2 py-sm-4 py-md-5">
    <div class="row justify-content-center">
      <div class="col-md-11 col-lg-10 col-xxl-8">
        <div class="login-card card">
          <div class="row g-0">
            <div class="col-md-5 position-relative d-flex justify-content-center">
              <img :src="loginImg" class="border border-card-border-width login-img img-cover shadow" :alt="`${VITE_COMPANY_NAME}-${title}`" />
            </div>
            <div class="col-md-7">
        ...
        <div class="col-md-7 offset-md-5 text-center pt-2">沒有帳號？<RouterLink to="/signup" class="text-reset">立即註冊</RouterLink></div>
      </div>
    </div>
  </div>
</template>
